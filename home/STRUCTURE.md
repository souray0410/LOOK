...
/data/<user>/LOOK/<release>/       runtime; never synchronized as source
|-- dataset/
|-- cache/
...
`-- runs/
    |-- experiments/               immutable deterministic formal runs
...
|-- resolved configuration and environment provenance
|-- frozen-backbone checkpoints and histories
|-- missing-input predictions and metrics
