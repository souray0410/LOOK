...
|   |   |-- MHD_Project/          MHD Framework V4 package
|   |   |-- tests/
|   |   |-- environment/
...
|-- run_config.json
|-- representation/{last/,best/,best.pt,history.json,training_complete.json}
|-- crt/{last/,best/,best.pt,history.json,training_complete.json}
...
`feature`. MHD Framework file and class names use `MHD_Framework_V4.py` and the
