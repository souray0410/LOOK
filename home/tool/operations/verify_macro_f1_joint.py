...
from look_core.unified_study import screening_stages
...
def main():
    ...
    case=expand_study_grid(dict(screening_stages(spec))["screen_layer3_3407"],paths,gpu_devices=(0,1),smoke_limit=8)[0]
