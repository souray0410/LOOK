...
def reset_and_forward(graph: MHD_Graph, oct_tensor: torch.Tensor, cfp_tensor: torch.Tensor) -> torch.Tensor:
    ...
    graph.forward()
    return graph.get_node_by_name("fusion_logits").current_state
