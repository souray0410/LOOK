...
def build_resnet50_mhd_graph(
    ...
    for branch in ("oct", "cfp", "fusion"):
        ...
        _add_edge(edges, f"{branch}_bilateral_pool_edge", BilateralMean())
...
def graph_summary(graph: MHD_Graph) -> Dict[str, object]:
    return {
        ...
        "participant_pooling": "bilateral_mean_linear_parameter_free",
