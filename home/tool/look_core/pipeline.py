...
class ExperimentRunner:
    ...
    def run(self) -> Dict[str, object]:
        ...
        with PipelineState(state_root, f"experiment__{self.experiment_id}__{self.options.phase}", state_config, [self.config.labels_csv]) as state:
    ...
    def _build_loaders(self):
        kwargs = {
            ...
            "preprocess_cache_root": self.config.cache_root / "preprocessed_pairs",
        }
        datasets = {
