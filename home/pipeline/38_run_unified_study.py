...
def main():
    ...
    spec=args.spec or paths.project_root/'configs/unified_study.json'
    from look_core.unified_study import run_unified_study
    print(json.dumps(run_unified_study(paths,spec,devices,args.execute),indent=2))
