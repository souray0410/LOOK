...
FILES=('README.zh-CN.md','registry.json','paths.py','check.py','check_framework.py','REPOSITORY_STANDARD.md','MODEL_RUN_STANDARD.md','GPU_EXECUTION_STANDARD.md','RESEARCH_AUDIT_STANDARD.md','DELIVERY_STANDARD.md','EFFICIENCY_STANDARD.md','stage_registry.py','STAGED_RESEARCH_STANDARD.md')
