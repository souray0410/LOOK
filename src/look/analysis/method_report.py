...
import json
import numpy as np
from look.runtime.state import atomic_write_json, atomic_write_text, utc_now
from look.studies.starts import read_json, file_record, verify_file, source_result
from look.analysis.start_report import write_csv
...
def include_self_input(summary, path, method_path):
    ...
    from look.studies.self_input import make_cases
...
def write_method_report(summary,destination,*,pdf=True):
    ...
    from look.analysis.findings import finding_sections, write_speaker_notes, tradeoff_figure, workflow_figure
