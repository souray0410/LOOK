...
from look.analysis.supplement import PATTERNS, validate_scope, save_npz
from look.evaluation.stability import logit_metrics
from look.runtime.evaluation import load_graph, compare_replay
from look.evaluation.held_out import job_artifacts
from look.data.dataset import UKBBilateralVisitDataset, make_loader
from look.methods.operator import load_selected_bank, downsample_flatten
from look.methods.joint import read_site, correction_sites
        ...
        for policy,model in settings:
            ...
            def run():
                ...
                if policy=='logit_affine':
                    from look.methods.logit import transform_logits
