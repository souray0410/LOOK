...
import torch
from look.studies.starts import SuffixRunner, read_json
...
def install_runtime():
    ...
    from look.studies import methods as method_study
    from look.methods import logit as method_logit
    from look.studies import starts as start_study
