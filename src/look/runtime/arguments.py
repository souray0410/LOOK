...
from look.runtime.paths import ProjectPaths, discover_project_root
...
def add_runtime_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--cohort-root", type=Path, help="Root containing primary and natural glaucoma cohorts.")
    parser.add_argument("--labels-csv", type=Path, help="Primary matched binary glaucoma table.")
    parser.add_argument("--natural-labels-csv", type=Path, help="Secondary natural-prevalence glaucoma table.")
