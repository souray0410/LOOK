...
import pytest
import torch
from look.training.trainer import selection_criterion
from look.evaluation.metrics import validation_macro_f1, validation_binary_auroc
from look.studies.pipeline import ExperimentRunner, PipelineOptions
from look.studies.protocol import screening_stages, selected_replication_stages, reference_stages, correction_stages, verify_f1_checkpoint
from look.studies.grid import expand_study_grid, _ranking_key
from tests.helpers.config import _paths,_config
...
def test_metric_changes_checkpoint_identity(tmp_path):
    from look.runtime.config import ExperimentSelection, ExperimentConfig
...
def test_factor_evaluation_covers_all_random_ratios(monkeypatch,tmp_path):
    import look.studies.pipeline as p
...
def test_look_acceptance_uses_f1_even_when_auc_disagrees(monkeypatch,tmp_path):
    ...
    import look.evaluation.evaluator as evaluate
    import look.analysis.matrices as analysis
