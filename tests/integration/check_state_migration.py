...
import torch
from look.models.graph import build_resnet50_mhd_graph, reset_and_forward
...
if mode=='after':
 assert json.loads(json.dumps(result))==json.loads((out/'before.json').read_text()),'Migration numerical mismatch'
